...
export function mapWbApiRowToAccrualRow(api: WbApiReportRow): WildberriesAccrualRow {
  return {
    ...
    wbCommission: parseNumber(api.vw ?? undefined) ?? 0,
    paymentServicesCommission: parseNumber(api.acquiringFee ?? undefined) ?? 0,
    pvzCompensation: parseNumber(api.ppvzReward ?? undefined) ?? 0,
    transportReimbursement: parseNumber(api.rebillLogisticCost ?? undefined) ?? 0,
    storageCost: parseNumber(api.paidStorage ?? undefined) ?? 0,
    withholdings: parseNumber(api.deduction ?? undefined) ?? 0,
    acceptanceOperations: parseNumber(api.paidAcceptance ?? undefined) ?? 0,
    fines: parseNumber(api.penalty ?? undefined) ?? 0,
    vvCorrection: parseNumber(api.additionalPayment ?? undefined) ?? 0,
    loyaltyCompensation: parseNumber(api.cashbackDiscount ?? undefined) ?? 0,
    loyaltyProgramCost: parseNumber(api.cashbackCommissionChange ?? undefined) ?? 0,
    loyaltyPointsWithheld: parseNumber(api.cashbackAmount ?? undefined) ?? 0,
  }
}
